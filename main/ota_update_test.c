...
static void _initNvsFlash(void)
{
...
static void _wifiStaStart(void * arg, esp_event_base_t event_base, int32_t event_id, void* event_data)
{
    ESP_LOGI(TAG, "STA start => connect to WiFi AP");
    ESP_ERROR_CHECK(esp_wifi_connect());
}

static void _wifiDisconnectHandler(void * arg_void, esp_event_base_t event_base, int32_t event_id, void * event_data)
{
...
static void _wifiConnectHandler(void * arg_void, esp_event_base_t event_base,  int32_t event_id, void * event_data)
{
...
static void _connect2wifi(char * const ipAddr)
{
